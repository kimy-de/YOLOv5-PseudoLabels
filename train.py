...
from utils.pdataset import added_pseudo_dataloader
...
def train(hyp, opt, device, tb_writer=None):
    ...
    if opt.pseudo:
        ...
        dataloader, dataset = added_pseudo_dataloader(train_path, pseudo_path, imgsz, batch_size, gs, opt,
                                                      hyp=hyp, augment=True, cache=opt.cache_images, rect=opt.rect,
                                                      rank=rank,
                                                      world_size=opt.world_size, workers=opt.workers)
    else:
        print("Using only train labels")
    ...
    # Model parameters
    hyp['cls'] *= nc / 15.  # scale coco-tuned hyp['cls'] to current dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pseudo', type=bool, default=True, help='semi-supervised learning')
